                      ...
                      double& intersection_distance) const
{
    ...
    double t = distance - (normal_[0]*ray.origin_[0] +
                           normal_[1]*ray.origin_[1] +
                           normal_[2]*ray.origin_[2]);
    t /= (normal_[0]*ray.direction_[0] +
          normal_[1]*ray.direction_[1] +
          normal_[2]*ray.direction_[2]);
